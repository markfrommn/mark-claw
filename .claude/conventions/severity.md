...
Errors a compiler/linter/interpreter would flag in planned code, where the
intended correct code is obvious from context. Build-blocking errors block
even though the fix is trivial; cosmetic errors that do not fail CI de-escalate.
