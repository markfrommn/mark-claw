...
| `09-correctness-security.md`       | "Is this correct and safe?"          | 6          |
...
| 09 Correctness & Security   |      Yes      |     Yes     |       Yes       |       Yes       |      Yes      |
...
Groups 03, 05 have no design facet (require actual code). Groups 01, 02, 06, 07, 09
...
| --------------- | ------------------ | ------ | -------------------------------------------- |
| Design Review   | 01, 02, 06, 07, 09 | design | 5 parallel QR agents (one per doc)           |
| Diff Review     | 01-05, 09          | code   | 6 parallel QR agents (one per doc)           |
| Codebase Review | 01-09              | code   | 9 parallel QR agents (one per doc)           |
| Refactor Design | 01, 02, 06, 07, 09 | design | N parallel Explore agents (one per category) |
| Refactor Code   | 01-09              | code   | N parallel Explore agents (one per category) |
